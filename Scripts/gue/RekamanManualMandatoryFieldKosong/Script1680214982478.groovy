...
Mobile.delay(5)
while (Mobile.verifyElementNotExist(findTestObject('Object Repository/gue/rekaman/rekamanEmptyStateText'), 2, FailureHandling.OPTIONAL)) {
	Mobile.tap(findTestObject('Object Repository/gue/rekaman/rekamanDateChangeButton'), 1)
}
...
Mobile.verifyElementExist(findTestObject('Object Repository/gue/rekaman/mandatoryFieldErrorMessage'), 2)